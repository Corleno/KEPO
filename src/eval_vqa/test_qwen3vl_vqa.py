...
# Note: pushd is no longer needed since images are already loaded as PIL objects
# But we keep it for compatibility with process_vision_info if needed
with pushd(IMAGE_FOLDER):
    for i in tqdm(range(0, len(messages), BSZ)):
        ...
        # Note: Think mode needs more tokens to output reasoning + answer
        # Increased from 256 to 1024 to allow complete reasoning and <answer> tags
