...
# Example usage: bash scripts/evaluation/train_MRI/qwen/eval_qwen3vl_2b_kdpo_nothink_mri_600_all_modalities_parallel.sh

# Model configuration
MODEL_PATH="/mnt/task_runtime/output/MM-GOLD/Qwen3-VL-2B-KDPO-MRI-600-nothink-tau-0"
MODEL_NAME="Qwen3-VL-2B-KDPO-MRI-600-nothink-tau-0"
BATCH_SIZE=16
MODE="nothink"
